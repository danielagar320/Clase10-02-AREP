...
import org.example.CheckPersonEligibleForSelectiveService;
...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        printPersons(personas, (CheckPerson) new CheckPersonEligibleForSelectiveService());
        printPersons(
                personas,
                new CheckPerson() {
        ...
        printPersonsWithPredicate(personas, (Person p) -> p.gender == Person.Sex.MALE
                && p.getAge() >= 18
                && p.getAge() <= 29);
        ...
        processPersonsWithFunction(personas,
        ...
        processElements(personas, p -> p.getGender() == Person.Sex.MALE
                        && p.getAge() >= 18
                        && p.getAge() <= 25,
                p -> p.getEmailAddress(),
                email -> System.out.println(email));
